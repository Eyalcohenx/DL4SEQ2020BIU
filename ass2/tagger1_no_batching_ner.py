...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        train_encoded = create_feature_vecs(random.choices(train_sents, k=2000), words_encoder, tags_encoder)
        total_loss = 0
        seen_instances = 0
        ...
        trainer.learning_rate = trainer.learning_rate / 5  # * ((total_loss / seen_instances) ** 1)

        # checking accuracy on dev set
        encoded_dev_sents = create_feature_vecs(random.choices(dev_sents, k=500), words_encoder, tags_encoder)
