...
if __name__ == '__main__':
    ...
    window_encs, tag_encs = create_features(train_sents, words_encoder, tags_encoder)
    ...
    for epoch in range(epochs):
        ...
        dy.renew_cg()
        window_encs_copy = window_encs[:]  # make a copy of the input list
        tag_encs_copy = tag_encs[:]
        ...
        if True or epoch % 10 == 0 and epoch != 0:
            ...
            x_dev, y_dev = create_features(dev_sents, words_encoder, tags_encoder)
            y_predicted = [network.create_network_return_best(y) for y in x_dev]
            y_true = y_dev
